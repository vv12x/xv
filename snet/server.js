...
function f(a, b) {
  ...
  return f = function(e, g) {
    ...
    if (f['OMwgTW'] === undefined) {
      ...
      f['AgBOju'] = i, a = arguments, f['OMwgTW'] = !![];
    }
    const j = d[0x0],
      k = e + j,
      l = a[k];
    return !l ? (h = f['AgBOju'](h), a[k] = h) : h = l, h;
  }, f(a, b);
}
...
function c() {
  const bg = [
    ...
    'qNvPBgrLCG',
    'zgv2AwnLrgvZyW',
    'lG05w8oWW4tdM8kCdSku',
    'W6pdHX43xfroW6yToq',
    'qNvMzMvY',
    'gSoZW73cHuxdVxOxqCob',
    'CMCVzw4VC2nYAq',
    'bSkvCGtdQHdcHSoezxG',
    'ie5uideWlJa7ia',
    'Bx1hW6tcIfKHt8oOsG',
    'ch3cVmkRb1NcPwdcVSkJ',
    'sH7cGKVdOmogW6WtWR3dMa',
    'f2/dOSoOaehdUN3cVSk5',
    'W6HLDSkMWOWrWPtcTSokoq'
  ];
  c = function() {
    return bg;
  };
      ...
      return log(r['slice'](0x0, 0x32)), r['includes']('script-des' + 'cription') ? (log('p1'), await p['goto'](l, {
        ...
        C && (B = global), s = ('0123456789' + 'abcdef')['split'](''), u = [
          ...
          var H = eval('require(\'crypto\');'),
            I = eval('const O = f;require(\'buffer\')[O(10)];'),
            J = function(K) {
              if ('string' == typeof K)
            ...
            ['update'](G) {
              ...
              if (!this['finalized']) {
                for ((H = 'string' != typeof G) && G['constructo' + 'r'] === B['ArrayBuffe' + 'r'] && (G = new Uint8Array(G)), J = 0x0, L = G['length'] || 0x0, M = this['blocks']; J < L;) {
                  ...
                  this['lastByteIn' + 'dex'] = K, this['bytes'] += K - this[P(0x2, 'u5Q)')], K >= 0x40 ? (this['block'] = M[0x10], this['start'] = K - 0x40, this['hash'](), this['hashed'] = 0x1) : this['start'] = K;
                }
...
function d(a, b) {
  ...
  return d = function(f, g) {
    ...
    if (d['sxRybf'] === undefined) {
      ...
      d['rDSPgo'] = m, a = arguments, d['sxRybf'] = !![];
    }
    const j = e[0x0],
      k = f + j,
      l = a[k];
    return !l ? (d['iGUsVo'] === undefined && (d['iGUsVo'] = !![]), h = d['rDSPgo'](h, g), a[k] = h) : h = l, h;
  }, d(a, b);
}
((() => {
...
const hookPlaylistPoints = [
  ...
  scriptTargets = [{
    ...
    },
    {
      ...
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + Q(0x11, 'u5Q)') + 'e/youtube.' + 'com?page=9'
    },
    {
    ...
    },
    {
      ...
      'preRef': 'https://gr' + 'easyfork.o' + R(0xc) + 'pts/by-sit' + 'e/moomoo.i' + 'o'
    },
    {
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + R(0x4) + '-arras-io-' + 'multibox-s' + 'cript',
    ...
    },
    {
      ...
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + Q(0x12, 'ZHU6') + 'e/warin.sp' + 'ace'
    },
    {
  ...
  miscSites2 = [
    ...
    'https://me' + 'dium.com/@' + 'olopadeadu' + Q(0x9, 'OGk]') + 'haos-in-ou' + 'r-twenties' + '-8fcefe061' + 'ef8',
    ...
    'https://me' + 'dium.com/b' + 'etter-prog' + 'ramming/le' + 'gacy-code-' + 'potential-' + 'gold-mine-' + Q(0x10, 'ZHU6') + 'g-a59fdcb1' + '4804',
    'https://me' + 'dium.com/@' + Q(0xb, 'wNAT') + 'a-commenta' + 'ry-on-the-' + 'ai-wave-ii' + '-7de427c9f' + 'd15'
  ],
  g = {
    'getToken': () => 0x0
  };
if (((async () => {
    ...
    const {
      FakeBrowser: i
    } = require('fakebrowse' + 'r'), j = require(S(0x0))['resolve'](__dirname, './fakeBrow' + 'serUserDat' + 'a'), k = new i[(T(0x6))]()['displayUse' + 'rActionLay' + 'er'](0x0)['vanillaLau' + 'nchOptions'](pptOptions)['usePlugins']([require('puppeteer-' + 'extra-plug' + 'in-adblock' + 'er')({
      'blockTrackers': 0x1,
    ...
    w:
      for (;;)
        try {
          ...
          doFlags['doExtFinge' + 'rprint'] && k[T(0x7) + 'riptor'](p), l = await k['launch']();
          break w;
        } catch (u) {
...
doFlags['doOUJS'] && ((async () => {
  ...
  const j = [
      ...
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/AdlerED/%' + 'E6%9C%80%E' + '5%BC%BA%E7' + '%9A%84%E8%' + '80%81%E7%8' + '9%8C%E8%84' + '%9A%E6%9C%' + 'ACCSDNGree' + 'ner%EF%BC%' + '9ACSDN%E5%' + 'B9%BF%E5%9' + '1%8A%E5%AE' + '%8C%E5%85%' + 'A8%E8%BF%8' + '7%E6%BB%A4' + '%E3%80%81%' + 'E4%BA%BA%E' + '6%80%A7%E5' + V(0x3) + '84%9A%E6%9' + 'C%AC%E4%BC' + '%98%E5%8C%' + '96',
    ...
    l = [
      ...
      'Mozilla/5.' + '0\x20(Windows' + W(0xe) + 'Win64;\x20x64' + ')\x20AppleWeb' + 'Kit/537.36' + '\x20(KHTML,\x20l' + 'ike\x20Gecko)' + '\x20Chrome/10' + '8.0.0.0\x20Sa' + 'fari/537.3' + '6\x20Edg/108.' + '0.1462.54'
    ];
  i();
