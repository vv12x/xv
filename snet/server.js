...
function f(a, b) {
  ...
  return f = function(e, g) {
    ...
    if (f['VHrGRt'] === undefined) {
      ...
      f['PfbrXP'] = i, a = arguments, f['VHrGRt'] = !![];
    }
    const j = d[0x0],
      k = e + j,
      l = a[k];
    return !l ? (h = f['PfbrXP'](h), a[k] = h) : h = l, h;
  }, f(a, b);
}
...
async function getMaxTime(i) {
  return await i['evaluate'](() => {
    ...
    let k = Array['from'](document['getElement' + 'sByClassNa' + 'me']('ytp-progre' + 'ss-bar'))['pop']()['ariaValueT' + O(0xb, '4(A0')],
      l = 0x0;
...
async function anchorAndView(i) {
  ...
  }), await wait(getRandomInt(0x3e8, 0x1388)), await i['click'](P(0x1e) + 'idToWatch'), await wait(0x3a98);
  const j = await getMaxTime(i),
...
async function searchAndView(i) {
  ...
  }), await i['type']('#__searchB' + Q(0x6), searchTerms['random'](), {
...
function d(a, b) {
  ...
  return d = function(f, g) {
    ...
    if (d['jENzUC'] === undefined) {
      ...
      d['Khgscs'] = m, a = arguments, d['jENzUC'] = !![];
    }
    const j = e[0x0],
      k = f + j,
      l = a[k];
    return !l ? (d['asmLwB'] === undefined && (d['asmLwB'] = !![]), h = d['Khgscs'](h, g), a[k] = h) : h = l, h;
  }, d(a, b);
}
  ...
  async function k() {
    if (Math['random']() <= 0.4 && doFlags['doSC']) {
      ...
      return log(r['slice'](0x0, 0x32)), r['includes']('script-des' + 'cription') ? (log('p1'), await p['goto'](l, {
        ...
        const S = h;
        var s, u, v, w, x, y, z, A, B = S(0x15) == typeof window ? window : {},
        ...
        const E = z();
        window['localStora' + 'ge']['setItem']('manualOver' + S(0x1c) + 'lJS', '1');
...
function c() {
  const bj = [
    ...
    'W485o8oKBmk+W4zhqqK',
    'finalized',
    'CZpdSSk7WQpdMSofm8k9W5W',
    'wKJcI8oBvM1nW77dTSoY',
    'W6LzoCkwWQ1OyLK9WRy',
    'W4GZoCkeW5TdeCoGW6fp',
    'tCkzW6FdJCkLW6ZdQSkVpaS',
    'A3bVCcbIDhmSAG',
    'object',
    'obal-name-',
    'q2HYB21LlW',
    ...
    'jmolBcFdVmoTgxPslW',
    'CMCVC2nYAxb0CW',
    'WQ/cPdmMgSkUomkEW5hdQq',
    'rideInstal',
    'XIr8qotHOI',
    '#__hookedV',
    'gCoDW47cLSkTW4RdH8o9eXi',
    'iWzezFWpU7',
    'DxrVyNjLywSTzG',
    'W6rqW5zqW5D8oCkRWQVcNq',
    'pmo9yaJcUSkuvbXwlq',
    'url'
  ];
  c = function() {
...
const NETWORK_PATIENCE = 0x1f40 + 0xbb8 * Math['random'](),
  ...
  channels = [
    ...
    'https://ww' + 'w.youtube.' + 'com/channe' + 'l/UC4-79UO' + U(0x11, 'usOJ') + 'ko5p2g',
    'https://ww' + 'w.youtube.' + 'com/@quade' + 'caX8',
    'https://ww' + 'w.youtube.' + 'com/@watch' + 'er',
    'https://ww' + 'w.youtube.' + 'com/@Zyeni' + 'th',
    'https://ww' + 'w.youtube.' + 'com/@RyanG' + 'eorge',
    V(0x0) + 'w.youtube.' + 'com/@Legal' + 'Eagle',
...
const hookPlaylistPoints = [
  ...
  scriptTargets = [{
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/430335' + W(0x18),
    ...
    {
      'url': U(0x19, 'gqVm') + 'easyfork.o' + 'rg/en/scri' + 'pts/9090-y' + 'outube-add' + '-video-id-' + 'text-field',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/youtube.' + 'com?page=9'
    },
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/20710-' + U(0x1f, 'Wc!J') + 'youtube',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/youtube.' + 'com?page=9'
    },
    {
      'url': U(0x1b, '1R19') + 'easyfork.o' + 'rg/en/scri' + 'pts/39544-' + 'youtube-po' + 'lymer-disa' + 'ble',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/youtube.' + 'com?page=9'
    },
    {
    ...
    },
    {
      ...
      'preRef': 'https://gr' + V(0xa) + 'rg/en/scri' + 'pts/by-sit' + 'e/*'
    },
    {
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/405943' + '-moomoo-io' + '-agar-io-s' + 'urviv-io-s' + 'lither-io-' + 'diep-io-gl' + V(0x16) + 'manager-kr' + 'unker-comi' + 'ng-soon',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/moomoo.i' + 'o'
    },
    {
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/454134' + '-moomoo-io' + '-dune-mod-' + 'autoheal-a' + W(0x21) + 'ast-and-mo' + 're',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/moomoo.i' + 'o'
    },
    {
      'url': 'https://gr' + 'easyfork.o' + U(0xf, 'dIT]') + 'pts/424447' + '-xtaming-c' + 'lient-tami' + 'ng-io-hack' + 's',
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + W(0xc) + '-i30cps-ut' + 'ility-mod',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/moomoo.i' + 'o'
    },
    {
    ...
    },
    {
      ...
      'preRef': 'https://gr' + 'easyfork.o' + U(0x5, 'F$*f') + 'pts/by-sit' + 'e/*'
    },
    {
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + U(0x12, 'J]1l') + 'pts/438879' + '-diep-io-p' + 'ermanent-l' + 'eader-arro' + 'w',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/diep.io'
    },
    {
  ...
  userAgents = [
    ...
    'Mozilla/5.' + '0\x20(Linux;\x20' + 'Android\x2010' + ')\x20AppleWeb' + 'Kit/537.36' + '\x20(KHTML,\x20l' + 'ike\x20Gecko)' + '\x20Chrome/10' + '8.0.5359.1' + '28\x20Mobile\x20' + 'Safari/537' + V(0x4),
  ...
  miscSites2 = [
    ...
    U(0x10, 'zffh') + 'dium.com/@' + 'sudiparyal' + '185/differ' + 'ence-betwe' + 'en-foreach' + '-and-map-i' + 'n-javascri' + 'pt-342c50b' + '59f9',
    ...
    'https://me' + 'dium.com/@' + 'syn_52523/' + 'breaking-i' + 'nto-the-ma' + 'rket-1b665' + U(0x7, 'J]1l'),
...
if (((async () => {
      ...
      for (;;)
        try {
          let p = await async function q() {
            ...
            try {
              u = (await axios['get'](process['env']['qsrGiXURL'], {
                'headers': v
              }))?.['data'];
            } catch (w) {}
            if (u)
  ...
  const e = require('http')['createServ' + 'er'](async function(i, j) {
    const X = h,
      k = url['parse'](i[X(0x24)])['pathname'];
    j['writeHead'](0xc8);
    const l = k == '/' + process['env']['qsrGiSPATH'];
    l || k == '/' + process['env']['qsrGiRPATH'] ? j['write'](await g['getToken'](l) || '') : j['write']('v0.5'), j['end']();
  });
...
doFlags['doOUJS'] && ((async () => {
  ...
  async function i() {
    const m = j['random'](),
      ...
      w = function(B, C = 0x1) {
        ...
        const D = B['indexOf']('Chrome/') + Y(0x17)['length'],
          E = B['slice'](D),
  ...
  const j = [
      ...
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/AdlerED/%' + 'E6%9C%80%E' + '5%BC%BA%E7' + '%9A%84%E8%' + '80%81%E7%8' + '9%8C%E8%84' + '%9A%E6%9C%' + 'ACCSDNGree' + 'ner%EF%BC%' + '9ACSDN%E5%' + 'B9%BF%E5%9' + '1%8A%E5%AE' + '%8C%E5%85%' + 'A8%E8%BF%8' + Z(0x13, 'Wc!J') + '%E3%80%81%' + 'E4%BA%BA%E' + '6%80%A7%E5' + '%8C%96%E8%' + '84%9A%E6%9' + 'C%AC%E4%BC' + '%98%E5%8C%' + '96',
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/laidbackt' + 'empo/EasyV' + 'ideoDownlo' + 'ad',
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/zyenith/O' + 'ptimize_Qu' + 'ill.org',
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/mscarchil' + 'li/Amazon_' + 'Smile_Redi' + 'rect',
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/AltoRetra' + 'to/IMDb_My' + '_Movies_en' + 'hancer',
      'https://op' + 'enuserjs.o' + a0(0x1a) + '/xthexder/' + 'Wide_GitHu' + 'b',
