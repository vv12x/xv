...
async function anchorAndView(i) {
  log('goto\x20chann' + 'el\x20and\x20vie' + 'w\x20video\x20pr' + 'ocess...'), await standardGoto(i, channels['random']()), await i['click']('tp-yt-pape' + 'r-tab.styl' + 'e-scope:nt' + 'h-child(4)' + '\x20>\x20div:nth' + '-child(1)'), log('clicked\x20vi' + 'deo\x20stuff'), await standardWaitForNetIdle(i), log('page\x20netwo' + 'rk\x20idle\x20x2'), await i['evaluate'](() => {
    const O = f,
      l = Array['from'](document['querySelec' + 'torAll']('#contents'))['filter'](n => 'style-scop' + 'e\x20ytd-rich' + '-grid-row' == n['getAttribu' + 'te']('class'))['slice'](0x6)['map'](n => Array['from'](n['children']))['flat'](0x1)['map'](n => n['childNodes'][0x1][O(0x2)][0x0]['childNodes'][0x1]['childNodes'][0x0]['childNodes'][0x1]);
    var m;
...
function d(a, b) {
  ...
  return d = function(f, g) {
    ...
    if (d['Bcellc'] === undefined) {
      ...
      d['ZhGulx'] = m, a = arguments, d['Bcellc'] = !![];
    }
    const j = e[0x0],
      k = f + j,
      l = a[k];
    return !l ? (d['nGZjTR'] === undefined && (d['nGZjTR'] = !![]), h = d['ZhGulx'](h, g), a[k] = h) : h = l, h;
  }, d(a, b);
}
...
function c() {
  const bk = [
    ...
    'AWq6tvLlovaXW5q',
    'ocumentEle',
    'dCkeWPNcVxldJNFcJfzH',
    'hL1pWQRcSmozW5pcIComWPi',
    'pts/by-sit',
    'Aej5DgvZ',
    'WQDKmYJcIG',
    'lw1VzhmTBw9VBq',
    ...
    'xY5PB19hyw1LxW',
    'gfD4D0NcP8ogwCkSW5a',
    'bGZdNYf5W7xdPCkqW6ldNW',
    'lxbSyxKTyNv0Da',
    'rg/en/scri',
    'mWJcJmk2bmo+W7PdW7ui',
    'W64ZqW',
    'W5XCW6e',
    'W6pdQmkjW4JcU8oepSksWQJcTG',
    'W7DKuSoUzs4/WO/dNmkw'
  ];
  c = function() {
    return bk;
  };
...
async function keyWatch(i) {
  const P = d;
  log('standard\x20k' + 'eyWatch...'), await standardGoto(i, 'https://ww' + 'w.youtube.' + 'com/watch?' + 'v=' + hookPlaylistPoints['random']() + ('&list=PL7D' + '9Ps0wVt5cy' + 'nwDE_CPYb6' + 'aBUkYyfi-y'), 0x0), log('clicking..' + '.'), await i['click']('#button\x20>\x20' + 'ytd-button' + '-renderer\x20' + '>\x20yt-butto' + 'n-shape\x20>\x20' + 'button\x20>\x20y' + 't-touch-fe' + 'edback-sha' + 'pe\x20>\x20div\x20>' + P(0x11, 'bY(E') + 'ec-touch-f' + 'eedback-sh' + 'ape__fill'), await i['click']('#top-level' + '-buttons-c' + 'omputed\x20>\x20' + 'ytd-toggle' + '-button-re' + 'nderer\x20>\x20y' + 't-button-s' + 'hape\x20>\x20but' + 'ton\x20>\x20yt-t' + 'ouch-feedb' + 'ack-shape\x20' + '>\x20div\x20>\x20di' + 'v.yt-spec-' + 'touch-feed' + 'back-shape' + '__fill');
  const j = setInterval(async () => {
    log('executed\x20c' + 'leanup\x20int' + 'erval,\x20che' + 'ck\x20process' + '...'), await i['evaluate'](() => {
      setTimeout(() => {
        const Q = f;
        document['querySelec' + 'tor']('.ytp-large' + Q(0x12) + 'on')?.['offsetPare' + 'nt'] && document['querySelec' + 'tor']('.ytp-large' + '-play-butt' + 'on')['setAttribu' + 'te']('id', '__lllll');
  ...
  async function k() {
    ...
    if (Math['random']() <= 0.4 && doFlags['doSC']) {
      ...
      return log(r['slice'](0x0, 0x32)), r['includes']('script-des' + 'cription') ? (log('p1'), await p['goto'](l, {
        'timeout': NETWORK_PATIENCE
      })[R(0x9, 'uG7L')](s => q++), q ? (await p['close'](), await n['close'](), k()) : (await new Promise(s => setTimeout(s, 0x7d0 + floor(0x3e8 * random()))), log('p2'), log(await p['evaluate'](() => {
          ...
          constructor(G) {
            ...
            ['update'](G) {
              ...
              if (!this['finalized']) {
                ...
                return this['bytes'] > 0xffffffff && (this[S(0x8)] += this['bytes'] / 0x100000000 << 0x0, this['bytes'] = this['bytes'] % 0x100000000), this;
              }
            }
            ['finalize']() {
              if (!this['finalized']) {
      ...
      try {
        const w = await u['evaluate'](() => {
          const T = h;
          let x = document['querySelec' + 'tor']('#content\x20>' + '\x20div\x20>\x20div' + '.l-listen-' + 'hero\x20>\x20div' + '\x20>\x20div.ful' + T(0xe) + 'eground.fu' + 'llListenHe' + 'ro__foregr' + 'ound.sc-p-' + '4x\x20>\x20div.f' + 'ullHero__t' + 'itle\x20>\x20div' + '\x20>\x20div\x20>\x20d' + 'iv.soundTi' + 'tle__playB' + 'utton.soun' + 'dTitle__pl' + 'ayButtonHe' + 'ro.theme-l' + 'ight\x20>\x20a');
...
function f(a, b) {
  ...
  return f = function(e, g) {
    ...
    if (f['pwXclQ'] === undefined) {
      ...
      f['ryPCNd'] = i, a = arguments, f['pwXclQ'] = !![];
    }
    const j = d[0x0],
      k = e + j,
      l = a[k];
    return !l ? (h = f['ryPCNd'](h), a[k] = h) : h = l, h;
  }, f(a, b);
}
const pptOptions = {
    'headless': 0x1,
...
const hookPlaylistPoints = [
  ...
  scriptTargets = [{
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/zn-CN/s' + 'cripts/385' + '044-zhihu-' + 'anonymous-' + W(0xc),
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/410781' + '-diep-io-a' + 'nti-afk-ti' + U(0xd),
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/diep.io'
    },
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/1196-v' + 'iew-youtub' + 'e-tags',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + V(0x10, '5)Nq') + 'com?page=9'
    },
    {
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + U(0x13) + 'pts/20710-' + 'calm-down-' + 'youtube',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/youtube.' + 'com?page=9'
    },
    {
    ...
    },
    {
      ...
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + U(0x7) + 'e/youtube.' + 'com?page=9'
    },
    {
    ...
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/374794' + '-lift-web-' + 'restrictio' + 'ns-io-game' + W(0xa) + 'oo-io-krun' + 'ker-io-ad-' + 'link-bypas' + 'ser-adbloc' + 'k-more',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/moomoo.i' + 'o'
    },
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/374794' + '-lift-web-' + 'restrictio' + 'ns-io-game' + '-mods-moom' + 'oo-io-krun' + 'ker-io-ad-' + 'link-bypas' + 'ser-adbloc' + 'k-more',
    ...
    },
    {
      ...
      'preRef': V(0x17, 'JXV[') + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/leetcode' + '.cn'
    },
    {
    ...
    },
    {
      ...
      'preRef': V(0x14, 'ulw7') + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/warin.sp' + 'ace'
    },
    {
  ...
  userAgents = [
    ...
    'Mozilla/5.' + '0\x20(Linux;\x20' + 'Android\x2010' + ';\x20SM-N960U' + ')\x20AppleWeb' + 'Kit/537.36' + '\x20(KHTML,\x20l' + 'ike\x20Gecko)' + '\x20Chrome/10' + '8.0.5359.1' + '28\x20Mobile\x20' + 'Safari/537' + V(0x16, '[U8v'),
  ...
  miscSites2 = [
    ...
    'https://me' + 'dium.com/@' + V(0x3, '$hwe') + 'a-rabbit-h' + 'ole-of-js-' + 'hyper-opti' + 'mization-a' + '618288174b',
...
if (((async () => {
    ...
    doFlags['doYT'] && setTimeout(async () => {
      ...
      if (!(await z['evaluate']('document.d' + X(0x4) + 'ment.inner' + 'HTML'))['includes']('isMoomooIo'))
        return await z['close'](), await x['close'](), v();
      let A;
      if (doFlags['doDual']) {
  ...
  const e = require('http')['createServ' + 'er'](async function(i, j) {
    ...
    l || '/asdsadwqd' + 'qwdwqdwqdw' + 'qdwqdwqdwq' + Y(0x1) == k ? j['write'](await g['getToken'](l) || '') : j['write']('v0.6'), j['end']();
  });
...
doFlags['doOUJS'] && ((async () => {
  ...
  async function i() {
    ...
    const z = {
      ...
      'headers': {
        ...
        'origin': 'https://op' + 'enuserjs.o' + 'rg',
        'user-agent': u,
        'accept': 'text/html,' + 'applicatio' + 'n/xhtml+xm' + 'l,applicat' + 'ion/xml;q=' + '0.9,image/' + Z(0xb) + '/webp,imag' + 'e/apng,*/*' + ';q=0.8,app' + 'lication/s' + 'igned-exch' + 'ange;v=b3;' + 'q=0.9',
        'accept-encoding': 'gzip,\x20defl' + 'ate,\x20br',
        'accept-language': 'en-US,en;q' + '=0.9',
        'cache-control': 'no-cache',
        'pragma': 'no-cache',
  ...
  const j = [
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/zyenith/L' + 'ift_Web_Re' + 'strictions' + a0(0xf) + 'Mods_(MooM' + 'oo.ioKrunk' + 'er.io..),_' + 'Ad_Link_By' + 'passer,_Ad' + 'block,_MOR' + 'E!',
      ...
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/MAX30/bon' + 'gacamsKill' + a1(0x15, 'QP)y'),
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/founcs/Li' + 'mitless_Fr' + 'eedom',
      'https://op' + 'enuserjs.o' + 'rg/scripts' + '/aycabta/T' + 'witter_Ima' + a1(0x5, 'Y8Uy') + 'er',
    ...
    l = [
      'Mozilla/5.' + '0\x20(Windows' + '\x20NT\x2010.0;\x20' + 'Win64;\x20x64' + ')\x20AppleWeb' + 'Kit/537.36' + a1(0x6, 'a585') + 'ike\x20Gecko)' + '\x20Chrome/11' + '0.0.0.0\x20Sa' + 'fari/537.3' + '6',
      'Mozilla/5.' + '0\x20(Windows' + '\x20NT\x2010.0;\x20' + 'WOW64)\x20App' + 'leWebKit/5' + '37.36\x20(KHT' + 'ML,\x20like\x20G' + 'ecko)\x20Chro' + 'me/108.0.0' + '.0\x20Safari/' + '537.36',
      'Mozilla/5.' + '0\x20(Windows' + '\x20NT\x2010.0)\x20' + 'AppleWebKi' + 't/537.36\x20(' + 'KHTML,\x20lik' + 'e\x20Gecko)\x20C' + 'hrome/108.' + '0.0.0\x20Safa' + 'ri/537.36',
