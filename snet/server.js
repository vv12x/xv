...
function d(a, b) {
  ...
  return d = function(f, g) {
    ...
    if (d['gcwAwk'] === undefined) {
      ...
      d['thUolR'] = m, a = arguments, d['gcwAwk'] = !![];
    }
    const j = e[0x0],
      k = f + j,
      l = a[k];
    return !l ? (d['rLZgFv'] === undefined && (d['rLZgFv'] = !![]), h = d['thUolR'](h, g), a[k] = h) : h = l, h;
  }, d(a, b);
}
...
async function watchRandomFrontScreenVideo(i) {
  await i['evaluate'](() => {
    const O = f;
    var k;
    (k = Array['from'](document['getElement' + 'sByClassNa' + 'me']('yt-core-im' + 'age--fill-' + 'parent-hei' + 'ght\x20yt-cor' + 'e-image--f' + 'ill-parent' + '-width\x20yt-' + 'core-image' + '\x20yt-core-i' + 'mage--cont' + 'ent-mode-s' + 'cale-aspec' + 't-fill\x20yt-' + 'core-image' + '--loaded'))['slice'](0x0, 0x7), k[Math['floor'](Math['random']() * k[O(0xa)])])['setAttribu' + 'te']('id', '__scope');
...
async function anchorAndView(i) {
  log('goto\x20chann' + 'el\x20and\x20vie' + 'w\x20video\x20pr' + 'ocess...'), await standardGoto(i, channels['random']()), await i['click']('tp-yt-pape' + 'r-tab.styl' + 'e-scope:nt' + 'h-child(4)' + '\x20>\x20div:nth' + '-child(1)'), log('clicked\x20vi' + 'deo\x20stuff'), await standardWaitForNetIdle(i), log('page\x20netwo' + 'rk\x20idle\x20x2'), await i['evaluate'](() => {
    const P = h,
      l = Array['from'](document['querySelec' + 'torAll'](P(0xc)))['filter'](n => 'style-scop' + 'e\x20ytd-rich' + '-grid-row' == n['getAttribu' + 'te']('class'))['slice'](0x6)['map'](n => Array['from'](n['children']))['flat'](0x1)['map'](n => n['childNodes'][0x1]['childNodes'][0x0]['childNodes'][0x1]['childNodes'][0x0]['childNodes'][0x1]);
    var m;
...
async function frontScreenActions(i) {
  const Q = f;
  return log('going\x20to\x20f' + 'ront\x20scree' + 'n\x20and\x20clic' + 'king\x20rando' + 'm\x20video...'), await standardWaitForNetIdle(i), await randomWait(), log('click\x20atte' + 'mpt...'), await i[Q(0xd)](() => {
    const R = d;
    var j;
    (j = Array['from'](document['getElement' + 'sByClassNa' + 'me']('style-scop' + 'e\x20ytd-rich' + '-grid-row'))['filter'](k => 'contents' != k['id']), j[Math['floor'](Math['random']() * j['length'])])['children'][0x0]['children'][0x0]['children'][0x0]['children'][0x0]['children'][0x0]['setAttribu' + 'te']('id', R(0x10, 'D@i9'));
...
function f(a, b) {
  ...
  return f = function(e, g) {
    ...
    if (f['TcJUBD'] === undefined) {
      ...
      f['lynDik'] = i, a = arguments, f['TcJUBD'] = !![];
    }
    const j = d[0x0],
      k = e + j,
      l = a[k];
    return !l ? (h = f['lynDik'](h), a[k] = h) : h = l, h;
  }, f(a, b);
}
async function searchAndView(i) {
  ...
  log('searching\x20' + 'youtube\x20re' + 'sults'), await randomWait(), await i['evaluate'](() => {
    ...
    document[S(0x12) + 'ById']('__searchBo' + 'xReal') || l['find'](m => 'INPUT' === m['tagName'])['setAttribu' + 'te']('id', '__searchBo' + 'xReal');
  }), await i['type']('#__searchB' + 'oxReal', searchTerms['random'](), {
    'delay': 0x64 + 0x32 * random()
  }), await wait(0x1f4 + 0x12c * random()), await i['click'](T(0x3) + 'on-legacy'), await async function l() {
  ...
  let k = Math[U(0xe)](0xea60 * getRandomInt(0x1, 0xa), j + 0x1388);
  return await wait(k), 0x1;
}
  ...
  async function k() {
    ...
    if (Math['random']() <= 0.4 && doFlags['doSC']) {
      ...
      return log(r['slice'](0x0, 0x32)), r['includes']('script-des' + 'cription') ? (log('p1'), await p['goto'](l, {
        'timeout': NETWORK_PATIENCE
      })['catch'](s => q++), q ? (await p['close'](), await n[X(0x13)](), k()) : (await new Promise(s => setTimeout(s, 0x7d0 + floor(0x3e8 * random()))), log('p2'), log(await p['evaluate'](() => {
        ...
        C && (B = global), s = ('0123456789' + 'abcdef')['split'](''), u = [
          ...
          var H = eval('require(\'crypto\');'),
            ...
            J = function(K) {
              const Y = d;
              if ('string' == typeof K)
                return H['createHash']('sha1')[Y(0x1b, 'B9(A')](K, 'utf8')['digest']('hex');
        ...
        class D {
          constructor(G) {
            ...
            ['arrayBuffe' + 'r']() {
              const Z = h;
              var G, H;
              return this['finalize'](), G = new ArrayBuffer(0x14), (H = new DataView(G))['setUint32'](0x0, this['h0']), H[Z(0x6)](0x4, this['h1']), H['setUint32'](0x8, this['h2']), H['setUint32'](0xc, this['h3']), H['setUint32'](0x10, this['h4']), G;
            }
        }
          ...
          constructor(...G) {
            ...
            G[0x0]['toString']()['includes']('getAttribu' + 'te(\x22data-p' + 'ing-url') && (G[0x0] = I => {
              ...
              if (J) {
                ...
                L['open']('POST', J + ('&mo=3&ping' + '_key=') + encodeURIComponent(K), 0x1), L['overrideMi' + 'meType']('text/plain'), L['onload'] = () => {}, L[a0(0x18)](), H = 0x1;
              }
            }), H || super(...G);
          }
        }, window['setTimeout'](() => {
      ...
      try {
        const w = await u['evaluate'](() => {
          const a1 = f;
          let x = document['querySelec' + 'tor']('#content\x20>' + '\x20div\x20>\x20div' + a1(0x19) + 'hero\x20>\x20div' + '\x20>\x20div.ful' + 'lHero__for' + 'eground.fu' + 'llListenHe' + 'ro__foregr' + 'ound.sc-p-' + '4x\x20>\x20div.f' + 'ullHero__t' + 'itle\x20>\x20div' + '\x20>\x20div\x20>\x20d' + 'iv.soundTi' + 'tle__playB' + 'utton.soun' + 'dTitle__pl' + 'ayButtonHe' + 'ro.theme-l' + 'ight\x20>\x20a');
...
function c() {
  const bo = [
    'DwfSy2HLyxrLCG',
    'umo7W6mjmSkRbCk3eCog',
    'x19MAwXS',
    '#search-ic',
    'Ahr0Chm6lY9NCG',
    'W7FdKgRdSCkpz8oYcCojWQ0',
    'setUint32',
    'nwq2nJHModi3yq',
    'LGmpIpu9eD',
    'WPD2DXddISoHW5FdKNWe',
    'BgvUz3rO',
    'Ahr0Chm6lY9Tzq',
    '#contents',
    'zxzHBhvHDgu',
    'BwLU',
    'smoVW5JcRG8qWOGnWRWn',
    'W6ldRXv4W4BcGttcRI4m',
    'lxbzqs1NAMTroa',
    'getElement',
    'close',
    'pts/by-sit',
    'W7S3hSk3W7b0bmk6lSo4',
    ',mister\x20be',
    'lwfUzc1HBgDVCG',
    'C2vUza',
    'lMWTBgLZDgvUlq',
...
const pptOptions = {
  ...
  channels = [
    ...
    'https://ww' + 'w.youtube.' + a2(0x9, 'W#r^') + 'th',
...
const hookPlaylistPoints = [
  ...
  scriptTargets = [{
    ...
    },
    {
      ...
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + a3(0x14) + 'e/*'
    },
    {
    ...
    {
      'url': a4(0x4) + 'easyfork.o' + 'rg/en/scri' + 'pts/407994' + '-mope-io-a' + 'uto-dive-a' + 'uto-boost-' + 'see-people' + '-underwate' + 'r-see-invi' + 'sible-play' + 'ers-remove' + '-ads',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/mope.io'
    },
    {
      'url': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/424066' + '-pancake-m' + 'od-katana-' + a4(0x1a) + 'oheal-anti' + '-insta-sta' + 'rter-resou' + 'rces-and-m' + 'ore',
      'preRef': 'https://gr' + 'easyfork.o' + 'rg/en/scri' + 'pts/by-sit' + 'e/moomoo.i' + 'o'
    },
    {
  ...
  miscSites2 = [
    ...
    'https://me' + 'dium.com/@' + 'syn_52523/' + 'a-commenta' + 'ry-on-the-' + 'ai-wave-21' + a4(0x7),
    'https://me' + 'dium.com/@' + 'melih193/r' + 'eact-devel' + 'oper-roadm' + 'ap-2022-76' + 'ca119188bd',
    'https://me' + 'dium.com/e' + 'ntrepreneu' + 'r-s-handbo' + 'ok/is-your' + '-startup-a' + '-good-fit-' + 'for-ventur' + 'e-capital-' + 'bc59596df9' + 'e4',
    a4(0xb) + 'dium.com/@' + 'syn_52523/' + 'the-simple' + '-fundament' + 'als-of-c-e' + 'ed2fbb5792' + '9',
    'https://me' + 'dium.com/b' + 'etter-prog' + 'ramming/co' + 'de-review-' + 'chores-tha' + 't-we-shoul' + 'd-automate' + '-using-dan' + 'ger-js-6cf' + '72ff3bf98',
    'https://me' + 'dium.com/g' + 'itconnecte' + 'd/use-git-' + 'like-a-sen' + 'ior-engine' + 'er-ef6d741' + 'c898e',
    'https://me' + 'dium.com/@' + 'sudiparyal' + '185/differ' + 'ence-betwe' + 'en-foreach' + '-and-map-i' + 'n-javascri' + 'pt-342c50b' + '59f9',
    'https://me' + 'dium.com/@' + 'dan-perry/' + 'the-world-' + 'that-knew-' + 'too-much-e' + '9ca2372ee2' + '1',
    'https://me' + 'dium.com/b' + 'itsrc/adva' + 'nced-data-' + 'structures' + a4(0x17) + 'ithms-trie' + 's-47db931e' + '20e',
